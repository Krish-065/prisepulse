...
export default function FinancialCalculators() {
  ...
  return (
    <div className="calculators-section" style={{ background: '#0a0e27', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '16px', padding: '24px', marginTop: '32px' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '240px 1fr', gap: '24px', alignItems: 'start' }}>
        
        {/* Navigation Sidebar */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          <h3 style={{ margin: '0 0 12px 6px', fontSize: '11px', fontWeight: 800, color: '#9b9eac', letterSpacing: '0.8px', textTransform: 'uppercase' }}>Calculators</h3>
        ...
        <div style={{ background: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.03)', borderRadius: '12px', padding: '20px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '24px' }}>
            ...
            <div>
              {calc === 'sip' && (
                <>
                  <h4 style={{ margin: '0 0 16px 0', fontSize: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}><TrendingUp size={16} style={{ color: '#00ff88' }} /> SIP Calculator</h4>
                  
                  <div style={{ marginBottom: '16px' }}>
                    <div style={{ display: 'flex', justifycontent: 'space-between', marginBottom: '6px' }}>
                      <span style={{ fontSize: '12px', color: '#9b9eac' }}>Monthly Investment</span>
                      <strong style={{ fontSize: '13px', color: '#ffffff' }}>₹{inputs.sipMonthly}</strong>
                    </div>
                  ...
                  <div style={{ marginBottom: '16px' }}>
                    <div style={{ display: 'flex', justifycontent: 'space-between', marginBottom: '6px' }}>
                      <span style={{ fontSize: '12px', color: '#9b9eac' }}>Time Period</span>
                      <strong style={{ fontSize: '13px', color: '#ffffff' }}>{inputs.sipYears} Years</strong>
                    </div>
                  ...
                  <div style={{ marginBottom: '16px' }}>
                    <div style={{ display: 'flex', justifycontent: 'space-between', marginBottom: '6px' }}>
                      <span style={{ fontSize: '12px', color: '#9b9eac' }}>Expected Returns (p.a.)</span>
                      <strong style={{ fontSize: '13px', color: '#ffffff' }}>{inputs.sipRate}%</strong>
                    </div>
              ...
              {calc === 'lumpsum' && (
                <>
                  <h4 style={{ margin: '0 0 16px 0', fontSize: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}><Coins size={16} style={{ color: '#00bcd4' }} /> Lumpsum Calculator</h4>

                  <div style={{ marginBottom: '16px' }}>
                    <div style={{ display: 'flex', justifycontent: 'space-between', marginBottom: '6px' }}>
                      <span style={{ fontSize: '12px', color: '#9b9eac' }}>Amount</span>
                      <strong style={{ fontSize: '13px', color: '#ffffff' }}>₹{inputs.lumpsumAmount}</strong>
                    </div>
                    <input type="range" min="5000" max="5000000" step="5000" value={inputs.lumpsumAmount} onChange={(e) => updateVal('lumpsumAmount', parseInt(e.target.value))} style={{ width: '100%', accentColor: '#00bcd4' }} />
                  </div>

                  <div style={{ marginBottom: '16px' }}>
                    <div style={{ display: 'flex', justifycontent: 'space-between', marginBottom: '6px' }}>
                      <span style={{ fontSize: '12px', color: '#9b9eac' }}>Time Period</span>
                      <strong style={{ fontSize: '13px', color: '#ffffff' }}>{inputs.lumpsumYears} Years</strong>
                    </div>
                  ...
                  <div style={{ marginBottom: '16px' }}>
                    <div style={{ display: 'flex', justifycontent: 'space-between', marginBottom: '6px' }}>
                      <span style={{ fontSize: '12px', color: '#9b9eac' }}>Expected Returns (p.a.)</span>
                      <strong style={{ fontSize: '13px', color: '#ffffff' }}>{inputs.lumpsumRate}%</strong>
                    </div>
              ...
              {calc === 'emi' && (
                <>
                  <h4 style={{ margin: '0 0 16px 0', fontSize: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}><Calculator size={16} style={{ color: '#00ff88' }} /> EMI Calculator</h4>

                  <div style={{ marginBottom: '16px' }}>
                    <div style={{ display: 'flex', justifycontent: 'space-between', marginBottom: '6px' }}>
                      <span style={{ fontSize: '12px', color: '#9b9eac' }}>Loan Amount</span>
                      <strong style={{ fontSize: '13px', color: '#ffffff' }}>₹{inputs.emiLoan}</strong>
                    </div>
                  ...
                  <div style={{ marginBottom: '16px' }}>
                    <div style={{ display: 'flex', justifycontent: 'space-between', marginBottom: '6px' }}>
                      <span style={{ fontSize: '12px', color: '#9b9eac' }}>Tenure</span>
                      <strong style={{ fontSize: '13px', color: '#ffffff' }}>{inputs.emiYears} Years</strong>
                    </div>
                  ...
                  <div style={{ marginBottom: '16px' }}>
                    <div style={{ display: 'flex', justifycontent: 'space-between', marginBottom: '6px' }}>
                      <span style={{ fontSize: '12px', color: '#9b9eac' }}>Interest Rate</span>
                      <strong style={{ fontSize: '13px', color: '#ffffff' }}>{inputs.emiRate}%</strong>
                    </div>
              ...
              {calc === 'brokerage' && (
                <>
                  <h4 style={{ margin: '0 0 16px 0', fontSize: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}><Percent size={16} style={{ color: '#00bcd4' }} /> Brokerage & Charges</h4>
                    ...
                    {['delivery', 'intraday', 'futures'].map(type => (
                      <button 
                        ...
                        style={{
                          ...
                          borderRadius: '6px',
                          background: inputs.brokerageType === type ? 'rgba(0,188,212,0.1)' : 'transparent',
                  ...
                  <div style={{ marginBottom: '10px' }}>
                    <label style={{ fontSize: '12px', color: '#9b9eac' }}>Buy Price</label>
                    <input type="number" value={inputs.brokerageBuy} onChange={(e) => updateVal('brokerageBuy', parseFloat(e.target.value) || 0)} style={{ width: '100%', padding: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', color: '#ffffff' }} />
                  </div>

                  <div style={{ marginBottom: '10px' }}>
                    <label style={{ fontSize: '12px', color: '#9b9eac' }}>Sell Price</label>
                    <input type="number" value={inputs.brokerageSell} onChange={(e) => updateVal('brokerageSell', parseFloat(e.target.value) || 0)} style={{ width: '100%', padding: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', color: '#ffffff' }} />
                  </div>

                  <div>
                    <label style={{ fontSize: '12px', color: '#9b9eac' }}>Quantity</label>
                    <input type="number" value={inputs.brokerageQty} onChange={(e) => updateVal('brokerageQty', parseFloat(e.target.value) || 0)} style={{ width: '100%', padding: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', color: '#ffffff' }} />
                  </div>
                </>
              )}
              ...
              {calc === 'position' && (
                <>
                  <h4 style={{ margin: '0 0 16px 0', fontSize: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}><Scale size={16} style={{ color: '#00ff88' }} /> Position Size</h4>

                  <div style={{ marginBottom: '10px' }}>
                    <label style={{ fontSize: '12px', color: '#9b9eac' }}>Trading Capital</label>
                    <input type="number" value={inputs.positionCapital} onChange={(e) => updateVal('positionCapital', parseFloat(e.target.value) || 0)} style={{ width: '100%', padding: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', color: '#ffffff' }} />
                  </div>

                  <div style={{ marginBottom: '10px' }}>
                    <label style={{ fontSize: '12px', color: '#9b9eac' }}>Risk (%)</label>
                    <input type="number" value={inputs.positionRisk} onChange={(e) => updateVal('positionRisk', parseFloat(e.target.value) || 0)} style={{ width: '100%', padding: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', color: '#ffffff' }} />
                  </div>

                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                    <div>
                      <label style={{ fontSize: '12px', color: '#9b9eac' }}>Entry</label>
                      <input type="number" value={inputs.positionEntry} onChange={(e) => updateVal('positionEntry', parseFloat(e.target.value) || 0)} style={{ width: '100%', padding: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', color: '#ffffff' }} />
                    </div>
                    <div>
                      <label style={{ fontSize: '12px', color: '#9b9eac' }}>Stop Loss</label>
                      <input type="number" value={inputs.positionStopLoss} onChange={(e) => updateVal('positionStopLoss', parseFloat(e.target.value) || 0)} style={{ width: '100%', padding: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', color: '#ffffff' }} />
                    </div>
                  </div>
                </>
              )}
              ...
              {calc === 'cagr' && (
                <>
                  <h4 style={{ margin: '0 0 16px 0', fontSize: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}><Briefcase size={16} style={{ color: '#00bcd4' }} /> CAGR Calculator</h4>

                  <div style={{ marginBottom: '10px' }}>
                    <label style={{ fontSize: '12px', color: '#9b9eac' }}>Initial Value</label>
                    <input type="number" value={inputs.cagrInitial} onChange={(e) => updateVal('cagrInitial', parseFloat(e.target.value) || 0)} style={{ width: '100%', padding: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', color: '#ffffff' }} />
                  </div>

                  <div style={{ marginBottom: '10px' }}>
                    <label style={{ fontSize: '12px', color: '#9b9eac' }}>Final Value</label>
                    <input type="number" value={inputs.cagrFinal} onChange={(e) => updateVal('cagrFinal', parseFloat(e.target.value) || 0)} style={{ width: '100%', padding: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', color: '#ffffff' }} />
                  </div>

                  <div>
                    <label style={{ fontSize: '12px', color: '#9b9eac' }}>Duration (Years)</label>
                    <input type="number" value={inputs.cagrYears} onChange={(e) => updateVal('cagrYears', parseFloat(e.target.value) || 0)} style={{ width: '100%', padding: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', color: '#ffffff' }} />
                  </div>
                </>
              )}
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px', padding: '16px' }}>
                <h5 style={{ margin: '0 0 12px 0', fontSize: '13px', color: '#ffffff', display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <HelpCircle size={14} style={{ color: '#00ff88' }} /> Results
                </h5>
                ...
                {result && (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    {Object.entries(result).map(([k, v]) => {
                      ...
                      return (
                        <div key={k} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid rgba(255,255,255,0.03)', paddingBottom: '8px' }}>
                          <span style={{ fontSize: '12px', color: '#9b9eac' }}>{label}</span>
                          <span style={{ 
                            fontSize: '15px', 
                            fontWeight: '700', 
